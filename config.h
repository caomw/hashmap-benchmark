...
const size_t kMemTest_rawDataMBytes_min = 1;
const size_t kMemTest_rawDataMBytes_max = 2;

//multiple-element-count speed test will test in this range
//single-element-count speed test will test at max
const size_t kSpeedTest_rawDataMBytes_min = 1;
const size_t kSpeedTest_rawDataMBytes_max = 2;
...
const size_t kNumRunsPerTest = 24;
